...
def recommend_movies(keyword, cosine_sim=cosine_sim, movie_data=movie, top_n=10):
    ...
    # Pastikan dataset memiliki 'poster_path', jika pakai TMDb formatnya "/path.jpg"
    image_base_url = "https://image.tmdb.org/t/p/w500"  # TMDb URL untuk poster
...
def movie_detail(title):
    ...
    image_base_url = "https://image.tmdb.org/t/p/w500"  # URL TMDb untuk poster
    ...
    if 'release_date' in movie_data and pd.notna(movie_data['release_date']):
        release_year = pd.to_datetime(movie_data['release_date'], errors='coerce')
